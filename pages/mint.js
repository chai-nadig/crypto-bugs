        ...
        <div className="md:w-2/3 w-4/5">
          <div className="mt-6 border-b-2 py-6">
            <div className="flex flex-col items-center">
                <span className="flex text-5xl text-white items-center bg-grey-lighter rounded rounded-r-none my-4 ">TOTAL BUGS MINTED:  <span className="text-blau text-6xl"> {!signedIn ?  <>-</>  :  <>{totalSupply}</> } / 8888</span></span>
                ...
                {saleStarted ? 
                <button onClick={() => mintBug(how_many_bugs)} className="mt-4 text-4xl border-6 bg-blau  text-white hover:text-black p-2 ">MINT {how_many_bugs} bugs for {(bugPrice * how_many_bugs) / (10 ** 18)} ETH + GAS</button>
